...
myFolders <- list.dirs(path ="/Users/rasmus/Desktop/VR_Method/RAW VR", full.names = FALSE)[-1]
...
for (i in 1:length(myList))
{
  ...
  participant_number <- sub(".*?(\\d+).*", "\\1", myList[i])# Essentially, this pattern captures the sequence of digits within the file name and ignores any other characters before or after the digits.
