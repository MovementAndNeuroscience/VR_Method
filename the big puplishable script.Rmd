...
# removing participants that did not meet the 55% critiria for the later outling removal
...
# calculateing the Z scores which represents the amount of standard deviations (SD) the participants is from the mean
 ...
 # removing participants that's outling more than 2+-sd 
  ATTENTION_filtered <- filter(ATTENTION_filtered, ID !="20002")
    ATTENTION_filtered <- filter(ATTENTION_filtered, ID !="30035")
    
# setting the complete data set where outliers and partcipants who did not meet 55% criteria are removed
